...
function execLinterCommand(args) {
  var cmd = `npx autorest@2.0.4245 --verbose --validation --azure-validator --message-format=regular ${args}`.trim();
...
describe('AutoRest Linter validation:', function () {
  if (utils.prOnly) {
    ...
    let configsToProcess = ['C:/dev/github/d3r3kk/azure-rest-api-specs/specification/applicationinsights/resource-manager/readme.md'];
